...
public interface PacienteRep extends JpaRepository<Paciente, String>{
    ...
    public List<Paciente> BuscarNombreApellidoProvincia(@Param("nombre") String nombre,@Param("apellido") String apellido,@Param("provincia") String provincia);
    ...
    public List<Paciente> BuscarNombreApellidoProvincia(@Param("nombre") String nombre,@Param("apellido") String apellido,@Param("provincia") String provincia,@Param("ciudad") String ciudad);
