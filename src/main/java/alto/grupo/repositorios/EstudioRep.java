...
public interface EstudioRep extends JpaRepository<Estudios, String>{
    ...
    @Query("SELECT c FROM Estudios c WHERE c.DNI LIKE :DNI ORDER BY c.fechaVisita DESC")
    public List<Estudios> buscarDNI(@Param("DNI") String DNI);
    
    @Query("SELECT c FROM Estudios c WHERE c.DNI LIKE :DNI AND c.especialidad LIKE %:especialidad% ORDER BY c.fechaVisita")
    public List<Estudios> buscarDNIEspecialidad(@Param("DNI") String DNI, @Param("especialidad") String especialidad);
    
    @Query("SELECT c FROM Estudios c WHERE c.DNI LIKE :DNI AND c.fechaVisita LIKE :fechaVisita ORDER BY c.fechaVisita")
    public List<Estudios> buscarDNIFecha(@Param("DNI") String DNI, @Param("fechaVisita") String fechaVisita);
    
    @Query("SELECT c FROM Estudios c WHERE c.DNI LIKE :DNI AND c.fechaVisita LIKE :fechaVisita AND c.especialidad LIKE %:especialidad% ORDER BY c.fechaVisita ")
    ...
    @Query("SELECT c FROM Estudios c WHERE c.matriculaInforme LIKE :matriculaInforme ORDER BY c.fechaVisita ")
    public List<Estudios> buscarMatriculaInforme(@Param("matriculaInforme") String matriculaInforme);
    
    @Query("SELECT c FROM Estudios c WHERE c.matriculaPide LIKE :matriculaPide ORDER BY c.fechaVisita")
    public List<Estudios> buscarMatriculaPide(@Param("matriculaPide") String matriculaPide);

    @Query("SELECT c FROM Estudios c WHERE c.matriculaInforme LIKE :matriculaInforme AND c.DNI LIKE :DNI ORDER BY c.fechaVisita")
    public List<Estudios> buscarMatriculaInformeDNI(@Param("matriculaInforme") String matriculaInforme, @Param("DNI") String DNI);
    
    @Query("SELECT c FROM Estudios c WHERE c.matriculaPide LIKE :matriculaPide AND c.DNI LIKE :DNI ORDER BY c.fechaVisita ")
    public List<Estudios> buscarMatriculaPideDNI(@Param("matriculaPide") String matriculaPide, @Param("DNI") String DNI);
    
    @Query("SELECT c FROM Estudios c WHERE c.centroMedico LIKE %:centroMedico% ORDER BY c.fechaVisita")
